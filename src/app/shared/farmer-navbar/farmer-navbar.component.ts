...
import { FarmerNotificationComponent } from '../../farmer/notification/notification.component';

@Component({
  selector: 'app-farmer-navbar',
  imports: [CommonModule,FarmerNotificationComponent,RouterModule],
  templateUrl: './farmer-navbar.component.html',
  styleUrl: './farmer-navbar.component.scss'
})
